...
public class BoardGame {
    ...
    private static BoardNode head; //top of board linked list
    private static BoardNode tail;//end of board linked list (points to head)
    private static BoardNode playHead; //head of player list
    private static BoardNode playTail; //tail of player list
    private static BoardNode compHead; //head of computer lsit
    private static BoardNode compTail; //tail of computer list
    ...
    public static void moveForward(int arrayIndex, int spacesToBeMoved, boolean isComputer) {
        ...
        //} else if(CheckPawnSafeZone(currentPositon, spacesToBeMoved, isComputer) == true) {
            ...
            userPos[arrayIndex] = currentPositon.getSpaceNum(); //update user position array
    ...
    public void playerPlays(Card sorryCard) {
        ...
        switch (sorryCard.getCardType()) {
            ...
            case TWO -> {
                ...
                if (playerChoice == 1) {//start a pawn
                    if(checkIfCanStartPawn(userPos) == true) {
                        //then can start pawn
                        startUserPawn();
            ...
            case SEVEN -> {
                //seven card, player input needed
    ...
    public static BoardNode getToStartNode(int arrayIndex){
        ...
        userPos[arrayIndex] = temp.getSpaceNum();
